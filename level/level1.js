const level1 = new Level(
  ...
  [
    new BackgroundObject("assets/img_pollo_locco/img/5_background/layers/air.png", -720, 0),
    new BackgroundObject("assets/img_pollo_locco/img/5_background/layers/3_third_layer/2.png", -720, 0),
    new BackgroundObject("assets/img_pollo_locco/img/5_background/layers/2_second_layer/2.png", -720, 0),
    new BackgroundObject("assets/img_pollo_locco/img/5_background/layers/1_first_layer/2.png", -720, 0),
