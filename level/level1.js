const level1 = new Level(
  ...
  [
    new AmmoPickup("assets/assets_sharkie/4. Marcadores/Posión/Light - Left.png", 150, 325),
    new AmmoPickup("assets/assets_sharkie/4. Marcadores/Posión/Light - Right.png", 700, 325),
    new AmmoPickup("assets/assets_sharkie/4. Marcadores/Posión/Light - Left.png", 900, 325),
    new AmmoPickup("assets/assets_sharkie/4. Marcadores/Posión/Light - Right.png", 1000, 325),
    new AmmoPickup("assets/assets_sharkie/4. Marcadores/Posión/Light - Right.png", 1300, 325),

    new AmmoPickup("assets/assets_sharkie/4. Marcadores/Posión/Light - Left.png", 1700, 325),
    new AmmoPickup("assets/assets_sharkie/4. Marcadores/Posión/Dark - Left.png", 2000, 325),
    new AmmoPickup("assets/assets_sharkie/4. Marcadores/Posión/Dark - Right.png", 2500, 325),
    new AmmoPickup("assets/assets_sharkie/4. Marcadores/Posión/Dark - Left.png", 2800, 325),
    new AmmoPickup("assets/assets_sharkie/4. Marcadores/Posión/Dark - Right.png", 3200, 325),
    new AmmoPickup("assets/assets_sharkie/4. Marcadores/Posión/Dark - Right.png", 3600, 325),
    new AmmoPickup("assets/assets_sharkie/4. Marcadores/Posión/Dark - Left.png", 3800, 325),
    new AmmoPickup("assets/assets_sharkie/4. Marcadores/Posión/Dark - Right.png", 4000, 325),
    new AmmoPickup("assets/assets_sharkie/4. Marcadores/Posión/Dark - Right.png", 4200, 325),
  ],
